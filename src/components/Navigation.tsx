...
export const BottomNav = () => {
  ...
  return (
    <nav className="md:hidden fixed bottom-0 w-full bg-white/90 dark:bg-emerald-950/90 backdrop-blur-lg border-t border-emerald-100 dark:border-emerald-900 z-50 px-6 py-3">
